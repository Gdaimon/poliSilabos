...
public class UsuariosFacadeREST extends AbstractFacade<ParUsuarios> {
    ...
    /**
     * Metodo que modifica un Usuario en la db
     * @param id
     * @param entity 
     */
    @PUT
    ...
    /**
     * Metodo que elimina un Usuario de la db
     * @param id 
     */
    @DELETE
    @Path("{id}")
    ...
    /**
     * Metodo que busca un Usuario por su id en la db
     * @param id
     * @return 
     */
    @GET
